...
{	
	...
	public static void main (String [] args)
	{
		...
		System.out.println("The minimum grade you can achieve is " + String.format("%.2f", min)  + "%");
		System.out.println("The maximum grade you can achieve is " + String.format("%.2f", max) + "%");
		System.out.println();
		...
		if (x < 100 && x > 0)
			System.out.println("To get an A+, you would need to get at least " + xx + "% over the remainder of the course.");
		...
		xx = String.format("%.2f", x); 
		if (x < 100 && x > 0)
			System.out.println("To get a B+, you would need to get at least " + xx + "% over the remainder of the course.");
		...
		xx = String.format("%.2f", x); 
		if (x < 100 && x > 0)
			System.out.println("To get a C+, you would need to get at least " + xx + "% over the remainder of the course.");
		...
		xx = String.format("%.2f", x); 
		if (x < 100 && x > 0)
			System.out.println("To get a D, you would need to get at least " + xx + "% over the remainder of the course.");
